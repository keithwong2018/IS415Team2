...
mpsz_demand <- mpsz_demand %>%
  dplyr::select(SUBZONE_N, PLN_AREA_N, REGION_N, X_ADDR, Y_ADDR, `65_to_69`, `70_to_74`, `75_to_79`, `80_to_84`, `85_to_89`, `90_and_over`, `elderly_count`, geometry)
```
...
mpsz_supply <- mpsz_supply %>%
  dplyr::select(SUBZONE_N, PLN_AREA_N, REGION_N, X_ADDR, Y_ADDR, geometry, eldercare, chas_clinic, silver_infocomm)
```
